...
export const outboxAbi = parseAbi([
  ...
  "function trustDelay() view returns (uint256)",
  "function hasRole(bytes32 role, address account) view returns (bool)",
  "function owner() view returns (address)",
  "function remainingAllowance(uint64 lane, address token) view returns (uint256)",
  "function limit(uint64 lane, address token) view returns (bool enabled, uint256 capacity, uint256 refillAmount, uint256 refillPeriod)",
  // events
